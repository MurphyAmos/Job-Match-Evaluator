                ...
                if similarity > .25:
                    ...
                    try:
                        ...
                        if json_y["verdict"] != "REJECT":
                            with open(f"outputs/{job_title.replace('/', '')}_Comparison_{i+1}.json", "w", encoding="utf-8") as f:
                                f.write(y)
                            continue
                        else:
                        ...
                        with open(f"outputs/{job_title.replace('/','')}_Comparison_{i+1}.text", "w", encoding="utf-8") as f:
                            f.write(y)
